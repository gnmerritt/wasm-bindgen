...
const __wbg_resolve_a96e53ca1abfddb3_target = (typeof Promise === 'undefined' ? null : Promise.resolve || function() {
    throw new Error(`wasm-bindgen: Promise.resolve does not exist`);
}).bind(Promise);

__exports.__wbg_resolve_a96e53ca1abfddb3 = function(arg0) {
    return addHeapObject(__wbg_resolve_a96e53ca1abfddb3_target(getObject(arg0)));
};

const __wbg_then_92a81916deabd290_target = typeof Promise === 'undefined' ? null : Promise.prototype.then || function() {
    throw new Error(`wasm-bindgen: Promise.then does not exist`);
};

__exports.__wbg_then_92a81916deabd290 = function(arg0, arg1) {
    return addHeapObject(__wbg_then_92a81916deabd290_target.call(getObject(arg0), getObject(arg1)));
};
...
__exports.__wbindgen_closure_wrapper190 = function(a, b, fi, di, _ignored) {
    const f = wasm.__wbg_function_table.get(fi);
    const d = wasm.__wbg_function_table.get(di);
    const cb = function(arg0) {
        this.cnt++;
